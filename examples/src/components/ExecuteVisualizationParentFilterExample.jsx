...
import { AttributeElements, Model, Visualization } from "@gooddata/react-components";
...
export class ExecuteVisualizationParentFilterExample extends Component {
    constructor(props) {
        super(props);
...
export default ExecuteVisualizationParentFilterExample;
