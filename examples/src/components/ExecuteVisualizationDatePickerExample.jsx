...
import { AfmComponents, ErrorComponent, Model, Visualization } from "@gooddata/react-components";
...
import {
    ...
    projectId,
    Stg3ParentFilterExecuteVisualizationUri,
} from "../utils/fixtures";

const dateFormat = "YYYY-MM-DD";

export class ExecuteVisualizationDatePickerExample extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="s-date-picker">
                ...
                <div style={{ height: 300 }} className="s-date-picker-chart">
                    {error ? (
                        ...
                        <Visualization
                            projectId={projectId}
                            uri={Stg3ParentFilterExecuteVisualizationUri}
                            filters={filters}
...
export default ExecuteVisualizationDatePickerExample;
