...
//Visualization on staging 3
export const Stg3PieVisualizationUri = `/gdc/md/${demoProjectId}/obj/9144`;
export const Stg3LineVisualizationUri = `/gdc/md/${demoProjectId}/obj/9145`;
export const Stg3AreaVisualizationUri = `/gdc/md/${demoProjectId}/obj/9146`;
export const Stg3ComboVisualizationUri = `/gdc/md/${demoProjectId}/obj/9147`;
export const Stg3DonutVisualizationUri = `/gdc/md/${demoProjectId}/obj/9148`;
export const Stg3ScatterVisualizationUri = `/gdc/md/${demoProjectId}/obj/9149`;
export const Stg3BubbleVisualizationUri = `/gdc/md/${demoProjectId}/obj/9150`;
export const Stg3TreeMapVisualizationUri = `/gdc/md/${demoProjectId}/obj/9151`;
export const Stg3HeatMapVisualizationUri = `/gdc/md/${demoProjectId}/obj/9152`;
export const Stg3PivotTableVisualizationUri = `/gdc/md/${demoProjectId}/obj/9145`;
export const Stg3ColumnVisualizationUri = `/gdc/md/${demoProjectId}/obj/6863`;
export const Stg3HeadlineVisualizationUri = `/gdc/md/${demoProjectId}/obj/9173`;
export const Stg3BarVisualizationUri = `/gdc/md/${demoProjectId}/obj/8840`;
export const Stg3ConfigVisualizationUri = `/gdc/md/${demoProjectId}/obj/9156`;
export const Stg3ExecuteVisualizationUri = `/gdc/md/${demoProjectId}/obj/9175`;
export const Stg3MufExecuteVisualizationUri = `/gdc/md/${demoProjectId}/obj/14884`;
export const Stg3ParentFilterExecuteVisualizationUri = `/gdc/md/${demoProjectId}/obj/9179`;
